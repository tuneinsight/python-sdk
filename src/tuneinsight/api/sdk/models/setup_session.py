...
class SetupSession:
    ...
    Attributes:
        ...
        relin_key (Union[Unset, bool]): whether or not to generate the relinearization key
        target_computation (Union[Unset, ComputationDefinition]): Generic computation.
        target_parameters (Union[Unset, str]): base64 encoded cryptolib parameters
    """
    ...
    relin_key: Union[Unset, bool] = UNSET
    target_computation: Union[Unset, ComputationDefinition] = UNSET
    target_parameters: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if relin_key is not UNSET:
            field_dict["relinKey"] = relin_key
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        relin_key = d.pop("relinKey", UNSET)
        ...
        target_parameters = d.pop("targetParameters", UNSET)
