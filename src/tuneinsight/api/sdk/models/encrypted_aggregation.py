...
class EncryptedAggregation:
    ...
    Attributes:
        ...
        allow_missing_columns (Union[Unset, bool]): - When set to true, dummy zero-value columns are created for any
            columns specified in the 'columns' parameter that are missing in the input dataset.
        ...
        include_count (Union[Unset, bool]): whether to include a 'count' column containing only '1's. This enables
            computing the average in post processing and used in DP mode to improve accuracy.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for columns_item_data in _columns or []:
            columns_item = ColumnProperties.from_dict(columns_item_data)
        ...
        include_count = d.pop("includeCount", UNSET)
