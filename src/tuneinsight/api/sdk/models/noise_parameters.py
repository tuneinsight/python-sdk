...
class NoiseParameters:
    """parameters for adding differential privacy noise to the computation's encrypted output (deprecated?)
    ...
    Attributes:
        ...
        epsilon (Union[Unset, float]): the execution quota Default: 0.2.
