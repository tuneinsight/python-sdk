...
class ComputationPreprocessingParametersCompoundPreprocessing:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            additional_property = PreprocessingChain.from_dict(prop_dict)

            additional_properties[prop_name] = additional_property

        computation_preprocessing_parameters_compound_preprocessing.additional_properties = additional_properties
        return computation_preprocessing_parameters_compound_preprocessing
