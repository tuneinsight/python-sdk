...
T = TypeVar("T", bound="PrivateSearch")
...
class PrivateSearch:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if pir_search_object_id is not UNSET:
            field_dict["pirSearchObjectId"] = pir_search_object_id
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        pir_search_object_id = d.pop("pirSearchObjectId", UNSET)
        ...
        private_search.additional_properties = d
