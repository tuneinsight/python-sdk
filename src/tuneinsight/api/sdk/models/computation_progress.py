...
T = TypeVar("T", bound="ComputationProgress")
...
class ComputationProgress:
    ...
    Attributes:
        ...
        can_skip_ahead (Union[Unset, bool]): Whether the computation loading stage can be interrupted to skip ahead with
            all the participants
            that have already loaded the data (with POST /computation/{id}/skipAhead).
    """
    ...
    can_skip_ahead: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        can_skip_ahead = self.can_skip_ahead
        ...
        if can_skip_ahead is not UNSET:
            field_dict["canSkipAhead"] = can_skip_ahead
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        can_skip_ahead = d.pop("canSkipAhead", UNSET)

        computation_progress = cls(
            running=running,
            cancelled=cancelled,
            failed=failed,
            ...
            can_skip_ahead=can_skip_ahead,
        )

        computation_progress.additional_properties = d
