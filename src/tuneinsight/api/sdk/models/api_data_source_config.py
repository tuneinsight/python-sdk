...
if TYPE_CHECKING:
    from ..models.api_connection_info import APIConnectionInfo


T = TypeVar("T", bound="ApiDataSourceConfig")
...
class ApiDataSourceConfig:
    ...
    Attributes:
        ...
        connection_info (Union[Unset, APIConnectionInfo]): Connection information for a API data sources
    """

    type: DataSourceConfigType
    connection_info: Union[Unset, "APIConnectionInfo"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        connection_info: Union[Unset, APIConnectionInfo]
        if isinstance(_connection_info, Unset):
            connection_info = UNSET
        else:
            connection_info = APIConnectionInfo.from_dict(_connection_info)

        api_data_source_config = cls(
            type=type,
            connection_info=connection_info,
        )

        api_data_source_config.additional_properties = d
        return api_data_source_config
