...
class Feasibility:
    ...
    Attributes:
        ...
        local_breakdown (Union[Unset, bool]): by default, the breakdown is skipped when computed locally, it can be re-
    ...
    local_breakdown: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        local_breakdown = self.local_breakdown
        ...
        if global_count is not UNSET:
            field_dict["globalCount"] = global_count
        if groups is not UNSET:
            field_dict["groups"] = groups
        if local_breakdown is not UNSET:
            field_dict["localBreakdown"] = local_breakdown
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for groups_item_data in _groups or []:
            groups_item = GroupingParameters.from_dict(groups_item_data)

            groups.append(groups_item)

        local_breakdown = d.pop("localBreakdown", UNSET)
        ...
        feasibility.additional_properties = d
        return feasibility
