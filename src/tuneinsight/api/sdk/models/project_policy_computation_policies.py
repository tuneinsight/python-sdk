...
class ProjectPolicyComputationPolicies:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            additional_property = ComputationPolicy.from_dict(prop_dict)

            additional_properties[prop_name] = additional_property

        project_policy_computation_policies.additional_properties = additional_properties
        return project_policy_computation_policies
