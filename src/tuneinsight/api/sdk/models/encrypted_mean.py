...
T = TypeVar("T", bound="EncryptedMean")
...
class EncryptedMean:
    ...
    Attributes:
        ...
        grouping_keys (Union[Unset, List[str]]): This parameter is used to specify the composite keys for grouping the
            ...
            for values where the attributes id and name differ.
            This parameter is essential for grouping the data before applying the aggregation function,
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        encrypted_mean.additional_properties = d
