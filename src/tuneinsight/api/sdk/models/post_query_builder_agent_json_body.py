...
if TYPE_CHECKING:
    ...
    from ..models.post_query_builder_agent_json_body_data_model_template import (
        PostQueryBuilderAgentJsonBodyDataModelTemplate,
    )


T = TypeVar("T", bound="PostQueryBuilderAgentJsonBody")


@attr.s(auto_attribs=True)
class PostQueryBuilderAgentJsonBody:
    """
    Attributes:
        data_model (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_query_builder_agent_json_body.additional_properties = d
        return post_query_builder_agent_json_body
