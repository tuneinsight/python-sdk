...
if TYPE_CHECKING:
    from ..models.binning_parameters import BinningParameters
...
T = TypeVar("T", bound="VBinnedAggregation")


@attr.s(auto_attribs=True)
class VBinnedAggregation:
    """
    Attributes:
        ...
        binning_column (Union[Unset, str]): the column on which to bin the data
    ...
    binning_column: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        binning_column = self.binning_column
        ...
        identifiable_columns: Union[Unset, List[str]] = UNSET
        if not isinstance(self.identifiable_columns, Unset):
            identifiable_columns = self.identifiable_columns
        ...
        if aggregation_column is not UNSET:
            field_dict["aggregationColumn"] = aggregation_column
        if binning_column is not UNSET:
            field_dict["binningColumn"] = binning_column
        if binning_parameters is not UNSET:
            field_dict["binningParameters"] = binning_parameters
        if identifiable_columns is not UNSET:
            field_dict["identifiableColumns"] = identifiable_columns
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        aggregation_column = d.pop("aggregationColumn", UNSET)

        binning_column = d.pop("binningColumn", UNSET)

        _binning_parameters = d.pop("binningParameters", UNSET)
        binning_parameters: Union[Unset, BinningParameters]
        if isinstance(_binning_parameters, Unset):
            binning_parameters = UNSET
        else:
            binning_parameters = BinningParameters.from_dict(_binning_parameters)

        identifiable_columns = cast(List[str], d.pop("identifiableColumns", UNSET))
        ...
        v_binned_aggregation = cls(
            ...
            binning_column=binning_column,
            binning_parameters=binning_parameters,
            identifiable_columns=identifiable_columns,
        )

        v_binned_aggregation.additional_properties = d
        return v_binned_aggregation
