...
T = TypeVar("T", bound="NodeStatusCatalogStatus")


@attr.s(auto_attribs=True)
class NodeStatusCatalogStatus:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        node_status_catalog_status = cls(
            last_updated=last_updated,
            progress=progress,
        )

        node_status_catalog_status.additional_properties = d
        return node_status_catalog_status
