...
T = TypeVar("T", bound="CollectEncryptedMasks")


@attr.s(auto_attribs=True)
class CollectEncryptedMasks:
    """
    Attributes:
        ...
        encrypted_data_object_id (Union[Unset, str]): Unique identifier of a data object.
        target_public_key_base_64 (Union[Unset, str]): the full target hybrid (i.e. classical+post-quantum secure with
            ECDH+MLKEM) public key in base-64 format.
    """
    ...
    encrypted_data_object_id: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        wait = self.wait
        encrypted_data_object_id = self.encrypted_data_object_id
        ...
        if encrypted_data_object_id is not UNSET:
            field_dict["encryptedDataObjectID"] = encrypted_data_object_id
        if target_public_key_base_64 is not UNSET:
            field_dict["targetPublicKeyBase64"] = target_public_key_base_64
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        encrypted_data_object_id = d.pop("encryptedDataObjectID", UNSET)

        target_public_key_base_64 = d.pop("targetPublicKeyBase64", UNSET)

        collect_encrypted_masks = cls(
            type=type,
            dp_policy=dp_policy,
            ...
            units=units,
            wait=wait,
            encrypted_data_object_id=encrypted_data_object_id,
            target_public_key_base_64=target_public_key_base_64,
        )

        collect_encrypted_masks.additional_properties = d
        return collect_encrypted_masks
