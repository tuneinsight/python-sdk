...
T = TypeVar("T", bound="SecureInference")
...
class SecureInference:
    ...
    Attributes:
        ...
        model_name (str): common name of the model to use for inference
        ...
        batch_size (Union[Unset, int]): number of samples to process in one batch Default: 16.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        secure_inference.additional_properties = d
