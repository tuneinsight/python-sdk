...
from ...models.result_definition import ResultDefinition
...
def sync_detailed(
    ...
    *,
    ...
    """modify the results metadata

    Args:
        result_id (str):
        json_body (ResultDefinition): user-defined computation result fields
