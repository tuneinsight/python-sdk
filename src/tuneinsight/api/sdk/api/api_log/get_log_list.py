...
def _parse_response(*, response: httpx.Response) -> Optional[Union[GetLogListResponse403, List[Log], str]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[GetLogListResponse403, List[Log], str]]:
    return Response(
