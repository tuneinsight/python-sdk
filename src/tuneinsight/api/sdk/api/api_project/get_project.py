...
def _parse_response(*, response: httpx.Response) -> Optional[Union[GetProjectResponse403, Project, str]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[GetProjectResponse403, Project, str]]:
    return Response(
