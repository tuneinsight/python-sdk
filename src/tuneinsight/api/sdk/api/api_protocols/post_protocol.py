...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[PostProtocolResponse403, str]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[PostProtocolResponse403, str]]:
    return Response(
