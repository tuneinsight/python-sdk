...
def _get_kwargs(
    *,
    ...
    url = "{}/datasource".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[DataSource, PostDataSourceResponse403, str]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[DataSource, PostDataSourceResponse403, str]]:
    return Response(
