...
def _parse_response(*, response: httpx.Response) -> Optional[Union[Any, DeleteDataSourceResponse403, str]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[Any, DeleteDataSourceResponse403, str]]:
    return Response(
