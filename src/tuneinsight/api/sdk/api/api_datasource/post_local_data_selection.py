...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/datasources/{dataSourceId}/selection".format(client.base_url, dataSourceId=data_source_id)
...
def sync_detailed(
    ...
    *,
    ...
    """saves the data selection for a datasource, runs the query first to verify that the selection work
