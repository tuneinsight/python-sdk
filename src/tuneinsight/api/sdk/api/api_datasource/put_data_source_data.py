...
def _parse_response(*, response: httpx.Response) -> Optional[Union[DataSource, PutDataSourceDataResponse403, str]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[DataSource, PutDataSourceDataResponse403, str]]:
    return Response(
